...
This error means your Unreal Engine installation is incomplete or corrupted. See the [TROUBLESHOOTING.md guide](TROUBLESHOOTING.md#unable-to-find-plugin-websockets) for solutions.
