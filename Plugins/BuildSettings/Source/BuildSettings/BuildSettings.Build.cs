...
public class BuildSettings : ModuleRules
{
    public BuildSettings(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        // The LoadingPhase is set to "PreDefault" in BuildSettings.uplugin to ensure this
        // module loads at the engine plugin level, preventing UBT from categorizing it as a
