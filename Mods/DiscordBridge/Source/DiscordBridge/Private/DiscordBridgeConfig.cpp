...
FDiscordBridgeConfig FDiscordBridgeConfig::LoadOrCreate()
{
	...
	else
	{
		...
		const FString DefaultContent =
			...
			TEXT("; Format for Discord -> game messages. Placeholder: {Username}, {PlayerName} (alias for {Username}), {Message}.\n")
			TEXT("DiscordToGameFormat={Message}\n")
			TEXT("; Format for the sender name shown in-game for Discord messages. Placeholder: {Username}, {PlayerName} (alias for {Username}).\n")
