...
FDiscordBridgeConfig FDiscordBridgeConfig::LoadOrCreate()
{
	...
	else
	{
		...
		const FString DefaultContent =
			...
			TEXT("; The text shown in the bot's Discord presence. Type whatever you like here.\n")
			TEXT("; Use %PlayerCount% to insert the live player count, %ServerName% for the server name.\n")
