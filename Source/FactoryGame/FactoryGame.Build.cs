...
public class FactoryGame : ModuleRules
{
	public FactoryGame( ReadOnlyTargetRules Target ) : base(Target)
	{
		...
		// Removed unreachable code for Win64 PAD_LIB_SUPPORT
		//</FL>
		...
		// Removed unreachable code for XSX platform dependencies
		...
		// Removed unreachable code for PS5 WITH_SHOWVAR definition
